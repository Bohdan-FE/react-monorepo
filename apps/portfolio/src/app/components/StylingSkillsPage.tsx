      ...
      <div className="max-w-6xl mx-auto px-4 text-white/90 py-29 overflow-hidden w-full h-fit relative">
        <div className="overflow-hidden">
          <motion.h2
            ...
            animate={{ y: 0 }}
            className="text-4xl md:text-6xl font-bold  text-center gradient-text leading-none "
          >
            {' '}
            Frontend Visual &
          </motion.h2>
        ...
        >
          ...
          as a technical tool to translate layouts into accurate,
        ...
        <section className="mb-10 md:mb-24">
          ...
          <div className="flex flex-wrap gap-12 justify-center">
            ...
            <TechnologyCard
              ...
              animation="right"
            >
              <ul className="space-y-1 flex flex-col items-center text-base text-center">
