...
function Authenticate() {
  ...
  return (
    <>
      <div className="h-screen  grid-cols-2  relative gap-10 p-4  bg-yellow-light overflow-hidden hidden md:grid">
        <div className="h-full  relative flex flex-col justify-center overflow-hidden gap-8 p-6 rounded-2xl shadow-big border-2 bg-blue-dark text-white border-black">
          ...
          <p className="max-w-md font-DMSans">
            Welcome back. Log in to continue your mission and connect with
            fellow ninjas in the Hidden Leaf Village
          </p>
